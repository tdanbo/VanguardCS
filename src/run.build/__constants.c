...
static void _createGlobalConstants(void) {
    ...
    Nuitka_SysSetObject(
        ...
        global_constants[85]
#else
        getStandaloneSysExecutablePath(global_constants[85])
#endif
    );
    ...
    PyStructSequence_SET_ITEM(Nuitka_dunder_compiled_value, 1, PyInt_FromLong(5));
