...
PyObject *CALL_FUNCTION_WITH_ARGS14_KWSPLIT(PyObject *called, PyObject *const *args, PyObject *const *kw_values, PyObject *kw_names) {
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        PyObject *result = Nuitka_CallFunctionPosArgsKwSplit(function, args, 14, kw_values, kw_names);
        ...
        if (likely(func != NULL)) {
            NUITKA_DYNAMIC_ARRAY_DECL(vectorcall_args, PyObject *, 14 + nkwargs);

            memcpy(vectorcall_args, args, 14*sizeof(PyObject *));
            memcpy(&vectorcall_args[14], kw_values, nkwargs*sizeof(PyObject *));

            PyObject *result = func(called, vectorcall_args, 14, kw_names);
